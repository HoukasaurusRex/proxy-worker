# Contributing to proxy-worker

First and foremost, thank you! We appreciate that you want to contribute to proxy-worker, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for proxy-worker**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for proxy-worker:

- star the [project](workers.houk.space/proxy/)
- tweet your support for proxy-worker
...
- **version**: (required) please note the version of proxy-worker are you using
...
The original poster or the maintainers of proxy-worker may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/proxy-worker
